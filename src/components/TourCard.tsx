...
const TourCard: React.FC<TourCardProps> = ({ tourID, tourName }) => {
    ...
    <>
        ...
        >
            ...
            <div style={{ marginTop: 12 }}>
                ...
                <Button type='primary' onClick={() => dispatch(openModal({tourID: tourID, tourName: tourName}))}>Забронировать</Button>
            </div>
        </Card>
    </>);
}
